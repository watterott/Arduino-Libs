...
class DisplayUART : public GraphicsLib
{
  public:
    DisplayUART();

    void begin(uint_least8_t rx_pin, uint_least8_t tx_pin, uint_least8_t cs_pin, uint_least8_t rst_pin);
    void begin(uint_least8_t rx_pin, uint_least8_t tx_pin, uint_least8_t cs_pin);
