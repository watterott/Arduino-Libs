...
All **standard characters** received over the serial port (default 9600 baud) and I2C (default address 8) will be shown on the display.
...
If ```0x12``` (18) is sent after this time and within 500ms then the serial baudrate will be set to 9600.
